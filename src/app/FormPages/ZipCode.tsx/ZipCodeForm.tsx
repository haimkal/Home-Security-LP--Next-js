...
type ZipCodeProps = ZipCodeData & {
  updateFields: (fields: Partial<ZipCodeProps>) => void;
  btnsDisplay: (show: boolean) => void;
};

export function ZipCodeForm({ zipCode, updateFields, btnsDisplay }: ZipCodeProps) {
  // why this component renders few times?
  useEffect(() => {
    btnsDisplay(true);
  }, [btnsDisplay]);
  ...
  return (
    <div className="form-section step2">
      <h4 className="form-title">What is your ZIP code?</h4>
